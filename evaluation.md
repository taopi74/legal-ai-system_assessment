...
- Re-draft: ~300-350 words, more concise, all sections have citations, explicit "Unclear from documents" markers
 ...
 ## Live Demonstration: Edit Loop in Action

### Original Draft (before any operator edit):
> **Parties:** GlobalFreight Ltd (Claimant) v. SwiftLogistics PLC (Defendant) [evidence_id:doc1:chunk:2]
> **Key Dates:** Contract signed in 2023. Breach occurred later. [evidence_id:doc1:chunk:3]
> The claimant seeks compensation for alleged delays and losses suffered 
> as a result of the defendant's failure to deliver goods on time...

### Operator Edit Submitted:
> **Parties:** GlobalFreight Ltd (Claimant) v. SwiftLogistics PLC (Defendant) [evidence_id:doc1:chunk:2]  
> **Key Dates:** Contract signed: 14 March 2023 [evidence_id:doc1:chunk:3]. Breach: 02 July 2023 [evidence_id:doc1:chunk:5]
> The claimant seeks £240,000 in damages for logistics failures. [evidence_id:doc1:chunk:4]
> **Notable Gaps:** Exact delivery schedule unclear from documents.

### Learned Patterns Extracted:
- style_notes: "Use specific dates, not vague references"
- structural_preferences: "Always cite evidence after key dates"  
- content_corrections: "Include monetary amounts when stated in source"

### Re-generated Draft (after learning):
> **Parties:** GlobalFreight Ltd (Claimant) v. SwiftLogistics PLC (Defendant) [evidence_id:doc1:chunk:2]
> **Key Dates:** Contract signed: 14 March 2023 [evidence_id:doc1:chunk:3]. Breach: 02 July 2023 [evidence_id:doc1:chunk:5]
> The claimant seeks £240,000 in damages [evidence_id:doc1:chunk:4] for logistics failures caused by defendant.
> **Notable Gaps:** Exact delivery schedule unclear from documents.
